...
draw.rectangle((5, 15, 200, 60), outline="black", fill="white")
draw.text((10, 20), 'this is a testtt', font=ImageFont.load_default(size=30), fill="black")

#push to screen or save to file
if TEST_MODE:
